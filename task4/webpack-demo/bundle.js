...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_leancloud_storage__ = __webpack_require__(15);
...
__WEBPACK_IMPORTED_MODULE_3_leancloud_storage___default.a.init({
  appId: APP_ID,
  appKey: APP_KEY
})
  ...
  methods: {
    ...
    addTodo() {
      ...
      this.todoList.push({
        title: this.todotext,
        check: false,
        date: __WEBPACK_IMPORTED_MODULE_0__bar__["a" /* format */](new Date(), 'yyyy-MM-dd hh: mm')
      })
      this.todotext = ''
    ...
    saveTodos() {
      ...
      var AVTodos = __WEBPACK_IMPORTED_MODULE_3_leancloud_storage___default.a.Object.extend('AllTodos');
      var avTodos = new AVTodos();
      // 把用户和储存的数据关联起来
      var acl = new __WEBPACK_IMPORTED_MODULE_3_leancloud_storage___default.a.ACL();
      acl.setReadAccess(__WEBPACK_IMPORTED_MODULE_3_leancloud_storage___default.a.User.current(), true); //只有当前用户可以读取
      acl.setWriteAccess(__WEBPACK_IMPORTED_MODULE_3_leancloud_storage___default.a.User.current(), true); //只有当前用户可以修改
    ...
    updateTodos() {
      let dataString = JSON.stringify(this.todoList);
      let avTodos = __WEBPACK_IMPORTED_MODULE_3_leancloud_storage___default.a.Object.createWithoutData('AllTodos', this.todoList.id);
      avTodos.set('content', dataString);
      avTodos.save().then(() => {
        console.log('更新成功')
      })
    ...
    signUp() {
      ...
      let user = new __WEBPACK_IMPORTED_MODULE_3_leancloud_storage___default.a.User();
    ...
    // 用户登入
    login() {
      __WEBPACK_IMPORTED_MODULE_3_leancloud_storage___default.a.User.logIn(this.formData.username, this.formData.password).then((loginedUser) => {
        this.currentUser = this.getCurrentUser();
        this.fetchTodos()
      }, (error) => { confirm(error) })
    },
    // 获取用户信息
    getCurrentUser() {
      let current = __WEBPACK_IMPORTED_MODULE_3_leancloud_storage___default.a.User.current();
      if (current) {
